...
class AutomationSettingsWindow(customtkinter.CTkToplevel):
    ...
    def parse_settings(self):
        ...
        self.map_render_check.check_state = bool(
            automation_settings.get("MapRender", False)
        )
